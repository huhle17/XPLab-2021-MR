...
const instructions_practice = magpieViews.view_generator("instructions", {
    ...
    text:  `In the following you will see pairs of geometrical objects. You then have to compare both objects and decide whether they are the same or different. If you think the objects are the same, please press “F” on your keyboard. If the objects are different, please press “J”. Always try to answer as quickly and accurately as you can.
            <br />
            <br />
